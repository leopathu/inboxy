...
const submit = () => {
    form.post(route('brands.lists.custom-fields.store', [props.brand.id, props.list.id]));
};
</script>

<template>
    <Head :title="`Create Custom Field - ${list.name} - ${brand.name}`" />
    ...
    <AuthenticatedLayout>
        <div class="py-12">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <!-- Header -->
                <div class="mb-6">
                    <h2 class="text-2xl font-bold text-gray-900">Create Custom Field</h2>
